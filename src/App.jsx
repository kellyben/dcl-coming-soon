      ...
      <footer className="relative z-10 py-8 px-6 border-t border-[#00ccff]/10">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="https://www.linkedin.com/company/diagnostic-centre-limited/posts/?feedView=all" className="w-10 h-10 rounded-lg bg-white/5 hover:bg-[#00ccff]/20 flex items-center justify-center text-[#ccd1d6] hover:text-[#00ccff] transition-all" target="_blank">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
